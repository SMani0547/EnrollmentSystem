...
namespace USPSystem.Migrations
{
    ...
    [Migration("20250601040403_CreateSpecialConsiderationApplicationTable")]
    partial class CreateSpecialConsiderationApplicationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("USPSystem.Models.AcademicProgram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("USPSystem.Models.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("USPSystem.Models.GraduationApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("GraduationCeremony")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("USPSystem.Models.RecheckApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("RecheckApplications");
                });

            modelBuilder.Entity("USPSystem.Models.SpecialConsiderationApplication", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ExamDate2")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ExamDate3")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ExamDate4")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ExamDate5")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ExamDate6")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("SpecialConsiderationApplications");
                });
            ...
            modelBuilder.Entity("AcademicProgramCourse", b =>
                {
                    b.HasOne("USPSystem.Models.Course", null)
                        .WithMany()
                        .HasForeignKey("CoreCoursesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("USPSystem.Models.AcademicProgram", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CourseProgramRequirement", b =>
                {
                    b.HasOne("USPSystem.Models.ProgramRequirement", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("USPSystem.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("USPSystem.Models.Course", b =>
                {
                    b.HasOne("USPSystem.Models.SubjectArea", "SubjectArea")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("USPSystem.Models.ProgramRequirement", b =>
                {
                    ...
                    b.HasOne("USPSystem.Models.SubjectArea", null)
                        .WithMany("Requirements")
            ...
            modelBuilder.Entity("USPSystem.Models.StudentEnrollment", b =>
                {
                    ...
                    b.HasOne("USPSystem.Models.Course", "Course")
                        .WithMany("StudentEnrollments")
