...
public interface IStudentGradeService
{
    ...
    Task<bool> ApplyForRecheckAsync(string studentId, string courseCode, int year, int semester, string reason, string? additionalComments, string email, string paymentReceiptNumber);
